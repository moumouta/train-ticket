package edu.cuhksz.swaggergenerator.config;
...
import edu.cuhksz.swaggergenerator.constant.ResponseStatus;
...
public class OpenApiConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("pdai", "http://pdai.tech", "yimouwu@link.cuhk.edu.cn"))
